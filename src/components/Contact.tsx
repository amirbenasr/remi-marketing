...
export default function Contact() {
  ...
  return (
    <section id="contact" className="section-panel contact-section min-h-screen bg-white py-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          {/* Left Side - Title & Contact Info */}
          <div className="relative">
            {/* Decorative circles */}
            <div className="absolute -top-20 -left-20 w-40 h-40 bg-gray-200 rounded-full blur-3xl opacity-50"></div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <input
                  ...
                  className="w-full border-b-2 border-black bg-transparent py-3 text-black placeholder-gray-400 focus:outline-none focus:border-gray-600"
                />
              </div>
